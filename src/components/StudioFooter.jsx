    ...
    <footer className="py-10 px-6 border-t border-[#1e1a14] text-center bg-[#080808]">
      <div className="flex flex-col items-center gap-3">
        <div className="flex items-center gap-3">
          <img src="/studio-logo.png" alt="The Marsh Refinery" className="w-6 h-6 object-contain opacity-60" style={{filter: "brightness(0) saturate(100%) invert(85%) sepia(20%) saturate(350%) hue-rotate(5deg) brightness(90%)"}} />
